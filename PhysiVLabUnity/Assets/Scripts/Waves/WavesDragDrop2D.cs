...
public class WavesDragDrop2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    private WavesUIDropTarget hoverTarget;

    public string ItemId => itemId;
    public bool IsPlaced { get; private set; }
    public System.Action<WavesDragDrop2D> OnCorrectDrop;
    public System.Action<WavesDragDrop2D> OnIncorrectDrop;
    public System.Action<WavesDragDrop2D> OnClicked;
    ...
    public void NotifyHoverTarget(WavesUIDropTarget target) => hoverTarget = target;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!IsPlaced) WavesEquipmentSnapController.Instance?.PlaceFromClick(this);
    }

    private WavesUIDropTarget FindDropTarget(PointerEventData eventData)
    {
        ...
        {
            var target = hit.gameObject.GetComponentInParent<WavesUIDropTarget>();
