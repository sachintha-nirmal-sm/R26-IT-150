...
public class WavesFailsafeDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (WavesUIManager.Instance != null) yield break;
        CreateOverlay();
    }
    ...
    public static void Hide()
    {
        ...
        var leftover = GameObject.Find("Waves_FailsafeRoot");
    ...
    private static void CreateOverlay()
    {
        ...
        overlay = new GameObject("Waves_FailsafeRoot");
        ...
        CreateUiText(header.transform, "WAVES AND THEIR APPLICATIONS", 42, Color.white, TextAnchor.MiddleCenter);

        CreateUiText(panel.transform, "PRACTICAL\n\n4.5 — Transverse waves using a slinky\n\nClick anywhere or press START", 32, new Color(0.12f, 0.16f, 0.22f), TextAnchor.MiddleCenter);
    ...
    {
        Hide();
        if (WavesExperimentManager.Instance != null)
            WavesExperimentManager.Instance.StartPractical();
        else if (WavesUIManager.Instance != null)
            WavesUIManager.Instance.StartPractical();
    }
