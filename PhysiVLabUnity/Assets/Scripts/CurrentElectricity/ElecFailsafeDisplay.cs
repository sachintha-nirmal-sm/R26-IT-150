...
public class ElecFailsafeDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (ElecUIManager.Instance != null) yield break;
        CreateOverlay();
    }
    ...
    public static void Hide()
    {
        ...
        var leftover = GameObject.Find("CE_FailsafeRoot");
    ...
    private static void CreateOverlay()
    {
        ...
        overlay = new GameObject("CE_FailsafeRoot");
        ...
        Debug.Log("Current Electricity emergency start overlay created.");
    }
    ...
    private static void Begin()
    {
        ...
        if (ElecUIManager.Instance != null)
            ElecUIManager.Instance.StartPractical();
        else
            Debug.LogWarning("Failsafe: ElecUIManager not ready. Stop Play and press Play again.");
    }
