...
public class WorkEnergyFailsafeDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (WorkEnergyUIManager.Instance != null) yield break;
        CreateOverlay();
    }
    ...
    public static void Hide()
    {
        ...
        var leftover = GameObject.Find("WEP_FailsafeRoot");
    ...
    private static void CreateOverlay()
    {
        ...
        overlay = new GameObject("WEP_FailsafeRoot");
        ...
        var header = CreateUiPanel(panel.transform, "Header", new Color(0.12f, 0.36f, 0.52f));
        var hrt = header.GetComponent<RectTransform>();
        hrt.anchorMin = new Vector2(0f, 0.82f);
        hrt.anchorMax = Vector2.one;
        hrt.offsetMin = hrt.offsetMax = Vector2.zero;
        CreateUiText(header.transform, "WORK, ENERGY AND POWER", 42, Color.white, TextAnchor.MiddleCenter);
        ...
        Debug.Log("Work Energy Power emergency start overlay created.");
    }
    ...
    private static void Begin()
    {
        ...
        if (WorkEnergyUIManager.Instance != null)
            ...
            Debug.LogWarning("Failsafe: WorkEnergyUIManager not ready. Stop Play and press Play again.");
    }
