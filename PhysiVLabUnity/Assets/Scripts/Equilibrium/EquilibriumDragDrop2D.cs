...
public class EquilibriumDragDrop2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    private EquilibriumUIDropTarget hoverTarget;

    public string ItemId => itemId;
    public bool IsPlaced { get; private set; }
    public System.Action<EquilibriumDragDrop2D> OnCorrectDrop;
    public System.Action<EquilibriumDragDrop2D> OnIncorrectDrop;
    public System.Action<EquilibriumDragDrop2D> OnClicked;
    ...
    public void NotifyHoverTarget(EquilibriumUIDropTarget target) => hoverTarget = target;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!IsPlaced) EquilibriumEquipmentSnapController.Instance?.PlaceFromClick(this);
    }

    private EquilibriumUIDropTarget FindDropTarget(PointerEventData eventData)
    {
        ...
        {
            var target = hit.gameObject.GetComponentInParent<EquilibriumUIDropTarget>();
