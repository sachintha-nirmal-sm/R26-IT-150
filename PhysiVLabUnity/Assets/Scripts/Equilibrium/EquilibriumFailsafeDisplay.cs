...
public class EquilibriumFailsafeDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (EquilibriumUIManager.Instance != null) yield break;
        CreateOverlay();
    }
    ...
    public static void Hide()
    {
        ...
        var leftover = GameObject.Find("Equilibrium_FailsafeRoot");
    ...
    private static void CreateOverlay()
    {
        ...
        overlay = new GameObject("Equilibrium_FailsafeRoot");
        ...
        var header = CreateUiPanel(panel.transform, "Header", new Color(0.10f, 0.22f, 0.38f));
        var hrt = header.GetComponent<RectTransform>();
        hrt.anchorMin = new Vector2(0f, 0.82f);
        hrt.anchorMax = Vector2.one;
        hrt.offsetMin = hrt.offsetMax = Vector2.zero;
        CreateUiText(header.transform, "EQUILIBRIUM OF FORCES", 42, Color.white, TextAnchor.MiddleCenter);
    ...
    {
        Hide();
        if (EquilibriumExperimentManager.Instance != null)
            EquilibriumExperimentManager.Instance.StartPractical();
        else if (EquilibriumUIManager.Instance != null)
            EquilibriumUIManager.Instance.StartPractical();
    }
    ...
    private static void CreateUiText(Transform parent, string content, int size, Color color, TextAnchor align)
    {
