...
public static class EquilibriumIconFactory
{
    private static readonly Dictionary<EquilibriumEquipmentType, Sprite> Cache = new Dictionary<EquilibriumEquipmentType, Sprite>();
    ...
    public static Sprite GetSprite(EquilibriumEquipmentType type)
    {
    ...
    public static Sprite GetNamed(string key)
    {
        ...
        switch (key)
        {
            ...
            case "stand": sprite = DrawStand(); break;
            case "band": sprite = DrawBand(); break;
    ...
    public static Color GetColor(EquilibriumEquipmentType type)
    {
        switch (type)
        {
            case EquilibriumEquipmentType.TwoSpringBalances: return new Color(0.78f, 0.22f, 0.18f);
            case EquilibriumEquipmentType.MeterRuler: return new Color(0.78f, 0.62f, 0.28f);
            case EquilibriumEquipmentType.TwoRubberBands: return new Color(0.22f, 0.22f, 0.24f);
            case EquilibriumEquipmentType.RetortStand: return new Color(0.45f, 0.48f, 0.52f);
            case EquilibriumEquipmentType.WoodenStick: return new Color(0.72f, 0.52f, 0.22f);
            case EquilibriumEquipmentType.Drill: return new Color(0.35f, 0.42f, 0.50f);
            case EquilibriumEquipmentType.ScrewNail: return new Color(0.62f, 0.64f, 0.68f);
            case EquilibriumEquipmentType.Wire: return new Color(0.85f, 0.72f, 0.28f);
            default: return new Color(0.82f, 0.86f, 0.92f);
        }
    }

    private static Sprite Draw(EquilibriumEquipmentType type)
    {
        switch (type)
        {
            case EquilibriumEquipmentType.TwoSpringBalances: return DrawBalance();
            case EquilibriumEquipmentType.MeterRuler: return DrawRuler();
            case EquilibriumEquipmentType.TwoRubberBands: return DrawBand();
            case EquilibriumEquipmentType.RetortStand: return DrawStand();
            case EquilibriumEquipmentType.WoodenStick: return DrawStick();
            case EquilibriumEquipmentType.Drill: return DrawDrill();
            case EquilibriumEquipmentType.ScrewNail: return DrawScrew();
            case EquilibriumEquipmentType.Wire: return DrawWire();
            case EquilibriumEquipmentType.Trolley: return DrawTrolley();
            case EquilibriumEquipmentType.Pulley: return DrawPulley();
            case EquilibriumEquipmentType.WoodenBlock: return DrawBlock();
            case EquilibriumEquipmentType.Sandpaper: return DrawSandpaper();
            case EquilibriumEquipmentType.LooseSpring: return DrawSpring();
            case EquilibriumEquipmentType.Ammeter: return DrawMeter("A", new Color(0.15f, 0.45f, 0.78f));
            case EquilibriumEquipmentType.Voltmeter: return DrawMeter("V", new Color(0.72f, 0.22f, 0.22f));
            case EquilibriumEquipmentType.Bulb: return DrawBulb();
            case EquilibriumEquipmentType.DryCell: return DrawCell();
            case EquilibriumEquipmentType.Beaker: return DrawBeaker();
            case EquilibriumEquipmentType.MeasuringCylinder: return DrawCylinder();
            case EquilibriumEquipmentType.Thermometer: return DrawThermometer();
            case EquilibriumEquipmentType.Magnet: return DrawMagnet();
            case EquilibriumEquipmentType.Stopwatch: return DrawStopwatch();
            case EquilibriumEquipmentType.MassHanger: return DrawHanger();
            case EquilibriumEquipmentType.Compass: return DrawCompass();
            case EquilibriumEquipmentType.BunsenBurner: return DrawBurner();
    ...
    private static Sprite DrawRuler()
    {
        ...
        FillRect(px, s, s, 16, 126, 224, 3, new Color(0.35f, 0.28f, 0.16f));
        for (int i = 0; i <= 10; i++)
        {
            int x = 24 + i * 20;
            FillRect(px, s, s, x, 108, 2, i % 5 == 0 ? 18 : 10, new Color(0.22f, 0.18f, 0.12f));
        }
        FillRect(px, s, s, 124, 96, 8, 12, new Color(0.75f, 0.18f, 0.16f));
        return Tex(px, s, s);
    }
    ...
    private static Sprite DrawStand()
    {
        int s = 256;
        var px = Clear(s, s);
        FillRect(px, s, s, 40, 200, 176, 22, new Color(0.28f, 0.30f, 0.34f));
        FillRect(px, s, s, 118, 40, 18, 170, new Color(0.55f, 0.58f, 0.62f));
        FillRect(px, s, s, 70, 48, 116, 14, new Color(0.42f, 0.45f, 0.50f));
        FillCircle(px, s, s, 78, 55, 8, new Color(0.72f, 0.22f, 0.18f));
        FillCircle(px, s, s, 178, 55, 8, new Color(0.12f, 0.52f, 0.32f));
        return Tex(px, s, s);
    }

    private static Sprite DrawBand()
    {
        int s = 256;
        var px = Clear(s, s);
        FillCircle(px, s, s, 128, 128, 62, new Color(0.18f, 0.18f, 0.20f));
        FillCircle(px, s, s, 128, 128, 38, Color.clear);
        FillCircle(px, s, s, 128, 128, 54, new Color(0.28f, 0.28f, 0.32f));
        FillCircle(px, s, s, 128, 128, 38, Color.clear);
        return Tex(px, s, s);
    }
