...
public class FrictionFailsafeDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (FrictionUIManager.Instance != null) yield break;
        CreateOverlay();
    }
    ...
    public static void Hide()
    {
        ...
        var leftover = GameObject.Find("Friction_FailsafeRoot");
    ...
    private static void CreateOverlay()
    {
        ...
        overlay = new GameObject("Friction_FailsafeRoot");
        ...
        var header = CreateUiPanel(panel.transform, "Header", new Color(0.28f, 0.18f, 0.10f));
        var hrt = header.GetComponent<RectTransform>();
        hrt.anchorMin = new Vector2(0f, 0.82f);
        hrt.anchorMax = Vector2.one;
        hrt.offsetMin = hrt.offsetMax = Vector2.zero;
        CreateUiText(header.transform, "FRICTION", 42, Color.white, TextAnchor.MiddleCenter);
    ...
    private static void Begin()
    {
        ...
        if (FrictionExperimentManager.Instance != null)
            FrictionExperimentManager.Instance.StartPractical();
        else if (FrictionUIManager.Instance != null)
            FrictionUIManager.Instance.StartPractical();
    }
