...
public class FrictionDragDrop2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    private FrictionUIDropTarget hoverTarget;

    public string ItemId => itemId;
    public bool IsPlaced { get; private set; }
    public System.Action<FrictionDragDrop2D> OnCorrectDrop;
    public System.Action<FrictionDragDrop2D> OnIncorrectDrop;
    public System.Action<FrictionDragDrop2D> OnClicked;
    ...
    public void NotifyHoverTarget(FrictionUIDropTarget target) => hoverTarget = target;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!IsPlaced) FrictionEquipmentSnapController.Instance?.PlaceFromClick(this);
    }

    private FrictionUIDropTarget FindDropTarget(PointerEventData eventData)
    {
        ...
        {
            var target = hit.gameObject.GetComponentInParent<FrictionUIDropTarget>();
