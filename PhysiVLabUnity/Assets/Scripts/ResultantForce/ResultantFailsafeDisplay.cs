...
public class ResultantFailsafeDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (ResultantUIManager.Instance != null) yield break;
        CreateOverlay();
    }
    ...
    public static void Hide()
    {
        ...
        var leftover = GameObject.Find("Resultant_FailsafeRoot");
    ...
    private static void CreateOverlay()
    {
        ...
        overlay = new GameObject("Resultant_FailsafeRoot");
        ...
        CreateUiText(header.transform, "RESULTANT FORCE", 42, Color.white, TextAnchor.MiddleCenter);
    ...
    private static void Begin()
    {
        ...
        if (ResultantExperimentManager.Instance != null)
            ResultantExperimentManager.Instance.StartPractical();
        else if (ResultantUIManager.Instance != null)
            ResultantUIManager.Instance.StartPractical();
    }
