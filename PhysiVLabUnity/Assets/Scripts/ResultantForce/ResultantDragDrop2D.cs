...
public class ResultantDragDrop2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    private ResultantUIDropTarget hoverTarget;

    public string ItemId => itemId;
    public bool IsPlaced { get; private set; }
    public System.Action<ResultantDragDrop2D> OnCorrectDrop;
    public System.Action<ResultantDragDrop2D> OnIncorrectDrop;
    public System.Action<ResultantDragDrop2D> OnClicked;
    ...
    public void NotifyHoverTarget(ResultantUIDropTarget target) => hoverTarget = target;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!IsPlaced) ResultantEquipmentSnapController.Instance?.PlaceFromClick(this);
    }

    private ResultantUIDropTarget FindDropTarget(PointerEventData eventData)
    {
        ...
        {
            var target = hit.gameObject.GetComponentInParent<ResultantUIDropTarget>();
