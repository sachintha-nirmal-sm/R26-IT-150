...
public class MotionDragDrop2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    private MotionUIDropTarget hoverTarget;

    public string ItemId => itemId;
    public float MeterValue => meterValue;
    public bool IsPlaced { get; private set; }
    public System.Action<MotionDragDrop2D> OnCorrectDrop;
    public System.Action<MotionDragDrop2D> OnIncorrectDrop;
    public System.Action<MotionDragDrop2D> OnClicked;
    ...
    public void NotifyHoverTarget(MotionUIDropTarget target) => hoverTarget = target;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!IsPlaced) MotionTrackController.Instance?.PlaceFromClick(this);
    }

    private MotionUIDropTarget FindDropTarget(PointerEventData eventData)
    {
        ...
        {
            var target = hit.gameObject.GetComponentInParent<MotionUIDropTarget>();
