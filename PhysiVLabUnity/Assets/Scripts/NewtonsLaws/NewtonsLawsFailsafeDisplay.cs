...
public class NewtonsLawsFailsafeDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (practicalStarted) yield break;
        if (NewtonUIManager.Instance != null) Hide();
        else CreateOverlay();
    }
    ...
    public static void Hide()
    {
        ...
        var leftover = GameObject.Find("Newton_FailsafeRoot");
    ...
    private static void CreateOverlay()
    {
        ...
        overlay = new GameObject("Newton_FailsafeRoot");
        ...
        CreateUiText(header.transform, "NEWTON'S LAWS OF MOTION", 40, Color.white, TextAnchor.MiddleCenter);

        CreateUiText(panel.transform,
            "Newton's Laws Investigation Lab\n\nInvestigating Newton's First, Second and Third Laws\n\nClick START PRACTICAL",
            30, new Color(0.12f, 0.16f, 0.22f), TextAnchor.MiddleCenter);
    ...
    {
        Hide();
        if (NewtonsLawsExperimentManager.Instance != null)
            NewtonsLawsExperimentManager.Instance.StartPractical();
        else if (NewtonUIManager.Instance != null)
            NewtonUIManager.Instance.StartPractical();
    }
    ...
    private static void CreateUiText(Transform parent, string content, int size, Color color, TextAnchor anchor)
    {
