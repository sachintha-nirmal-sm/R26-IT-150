...
public class NewtonDragDrop2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    public System.Action<NewtonDragDrop2D> OnCorrectDrop;
    public System.Action<NewtonDragDrop2D> OnIncorrectDrop;
    public System.Action<NewtonDragDrop2D> OnClicked;
    private NewtonUIDropTarget hoverTarget;

    public void Configure(string id, float meters = 0f)
    {
        itemId = id;
        meterValue = meters;
    }
    ...
    public void NotifyHoverTarget(NewtonUIDropTarget target) => hoverTarget = target;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!IsPlaced) NewtonEquipmentSnapController.Instance?.PlaceFromClick(this);
    }

    private NewtonUIDropTarget FindDropTarget(PointerEventData eventData)
    {
        ...
        {
            var target = hit.gameObject.GetComponentInParent<NewtonUIDropTarget>();
