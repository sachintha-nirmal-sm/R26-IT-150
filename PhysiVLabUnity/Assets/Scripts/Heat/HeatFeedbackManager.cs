...
public class HeatFeedbackManager : MonoBehaviour
{
    public static HeatFeedbackManager Instance { get; private set; }
    ...
    public void ShowInstruction(string message) =>
        ShowMessage(message, "", new Color(0.55f, 0.28f, 0.10f));
