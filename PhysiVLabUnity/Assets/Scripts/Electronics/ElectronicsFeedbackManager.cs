...
public class ElectronicsFeedbackManager : MonoBehaviour
{
    public static ElectronicsFeedbackManager Instance { get; private set; }
    ...
    public void ShowInstruction(string message) =>
        ShowMessage(message, "", new Color(0.12f, 0.32f, 0.55f));
