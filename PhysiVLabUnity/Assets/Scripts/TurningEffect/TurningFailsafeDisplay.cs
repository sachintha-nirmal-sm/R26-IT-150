...
public class TurningFailsafeDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (TurningUIManager.Instance != null) yield break;
        CreateOverlay();
    }
    ...
    public static void Hide()
    {
        ...
        var leftover = GameObject.Find("Turning_FailsafeRoot");
    ...
    private static void CreateOverlay()
    {
        ...
        overlay = new GameObject("Turning_FailsafeRoot");
        ...
        CreateUiText(header.transform, "TURNING EFFECT OF A FORCE", 42, Color.white, TextAnchor.MiddleCenter);
    ...
    {
        Hide();
        if (TurningExperimentManager.Instance != null)
            TurningExperimentManager.Instance.StartPractical();
        else if (TurningUIManager.Instance != null)
            TurningUIManager.Instance.StartPractical();
    }
