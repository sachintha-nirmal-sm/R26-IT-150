...
public class TurningDragDrop2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    private TurningUIDropTarget hoverTarget;

    public string ItemId => itemId;
    public bool IsPlaced { get; private set; }
    public System.Action<TurningDragDrop2D> OnCorrectDrop;
    public System.Action<TurningDragDrop2D> OnIncorrectDrop;
    public System.Action<TurningDragDrop2D> OnClicked;
    ...
    public void NotifyHoverTarget(TurningUIDropTarget target) => hoverTarget = target;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!IsPlaced) TurningEquipmentSnapController.Instance?.PlaceFromClick(this);
    }

    private TurningUIDropTarget FindDropTarget(PointerEventData eventData)
    {
        ...
        {
            var target = hit.gameObject.GetComponentInParent<TurningUIDropTarget>();
