...
public class OpticsFailsafeDisplay : MonoBehaviour
{
    ...
    private IEnumerator Start()
    {
        ...
        if (OpticsUIManager.Instance != null) yield break;
        CreateOverlay();
    }
    ...
    public static void Hide()
    {
        ...
        var leftover = GameObject.Find("Optics_FailsafeRoot");
    ...
    private static void CreateOverlay()
    {
        ...
        overlay = new GameObject("Optics_FailsafeRoot");
        ...
        CreateUiText(header.transform, "GEOMETRICAL OPTICS", 42, Color.white, TextAnchor.MiddleCenter);
    ...
    {
        Hide();
        if (OpticsExperimentManager.Instance != null)
            OpticsExperimentManager.Instance.StartPractical();
        else if (OpticsUIManager.Instance != null)
            OpticsUIManager.Instance.StartPractical();
    }
