...
public class OpticsDragDrop2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    private OpticsUIDropTarget hoverTarget;

    public string ItemId => itemId;
    public bool IsPlaced { get; private set; }
    public System.Action<OpticsDragDrop2D> OnCorrectDrop;
    public System.Action<OpticsDragDrop2D> OnIncorrectDrop;
    public System.Action<OpticsDragDrop2D> OnClicked;
    ...
    public void NotifyHoverTarget(OpticsUIDropTarget target) => hoverTarget = target;
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!IsPlaced) OpticsEquipmentSnapController.Instance?.PlaceFromClick(this);
    }

    private OpticsUIDropTarget FindDropTarget(PointerEventData eventData)
    {
        ...
        {
            var target = hit.gameObject.GetComponentInParent<OpticsUIDropTarget>();
