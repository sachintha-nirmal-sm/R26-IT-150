...
public class PowerEnergyDragDrop2D : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IPointerClickHandler
{
    ...
    private PowerEnergyUIDropTarget hoverTarget;

    public string ItemId => itemId;
    public bool IsPlaced { get; private set; }
    public System.Action<PowerEnergyDragDrop2D> OnCorrectDrop;
    public System.Action<PowerEnergyDragDrop2D> OnIncorrectDrop;
    public System.Action<PowerEnergyDragDrop2D> OnClicked;
    ...
    public void NotifyHoverTarget(PowerEnergyUIDropTarget target) => hoverTarget = target;
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        if (target != null && !target.CanAccept(this))
        {
            PowerEnergyCircuitConnectionManager.Instance?.NotifyWrongDrop(this, target);
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if (!IsPlaced) PowerEnergyEquipmentSnapController.Instance?.PlaceFromClick(this);
    }

    private PowerEnergyUIDropTarget FindDropTarget(PointerEventData eventData)
    {
        ...
        {
            var target = hit.gameObject.GetComponentInParent<PowerEnergyUIDropTarget>();
