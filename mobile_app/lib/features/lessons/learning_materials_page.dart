...
class _LearningMaterialsPageState extends State<LearningMaterialsPage> {
  ...
  void _downloadMaterial(LessonMaterial m) {
    ...
    // Transform Cloudinary URL to include fl_attachment to force direct browser
    // attachment download. This avoids XHR CORS 401 Unauthorized errors when
    // fetching raw files via JS http.get.
    String downloadUrl = m.cloudinaryUrl;

    if (downloadUrl.contains('/upload/') &&
        !downloadUrl.contains('fl_attachment')) {
